# OpenWeatherMap API to S3 bucket to Snowflake ETL Pipeline by Aiflow on EC2 with email notification
...
![img1](https://github.com/vaxdata22/WeatherAPI-to-S3-bucket-to-Snowflake-ETL-by-Aiflow-on-EC2/blob/main/screenshots/img1.png)

![img2](https://github.com/vaxdata22/WeatherAPI-to-S3-bucket-to-Snowflake-ETL-by-Aiflow-on-EC2/blob/main/screenshots/img2.png)
<br><br>
...
![img3](https://github.com/vaxdata22/WeatherAPI-to-S3-bucket-to-Snowflake-ETL-by-Aiflow-on-EC2/blob/main/screenshots/img3.png)
<br><br>
...
![img5](https://github.com/vaxdata22/WeatherAPI-to-S3-bucket-to-Snowflake-ETL-by-Aiflow-on-EC2/blob/main/screenshots/img5.png)

In between, I would test run the DAG via the web browser (and this requires stopping and restarting Airflow via the CLI). All aspects of the orchestration were tested, including the DAG run failure and retry. See the finished Airflow orchestration DAG Python file [here.](https://github.com/vaxdata22/WeatherAPI-to-S3-bucket-to-Snowflake-ETL-by-Aiflow-on-EC2/blob/main/codes/lagos_weather_dag.py)
<br><br>
...
![img6](https://github.com/vaxdata22/WeatherAPI-to-S3-bucket-to-Snowflake-ETL-by-Aiflow-on-EC2/blob/main/screenshots/img6.png)

Screenshot of CSV file in S3 bucket Data Lake:
![img7](https://github.com/vaxdata22/WeatherAPI-to-S3-bucket-to-Snowflake-ETL-by-Aiflow-on-EC2/blob/main/screenshots/img7.png)

Screenshot of loaded Snowflake table showing the 17 columns of the table:
![img8](https://github.com/vaxdata22/WeatherAPI-to-S3-bucket-to-Snowflake-ETL-by-Aiflow-on-EC2/blob/main/screenshots/img8.png)

Screenshots showing some of the data in the destination Snowflake table:
![img9](https://github.com/vaxdata22/WeatherAPI-to-S3-bucket-to-Snowflake-ETL-by-Aiflow-on-EC2/blob/main/screenshots/img9.png)

![img10](https://github.com/vaxdata22/WeatherAPI-to-S3-bucket-to-Snowflake-ETL-by-Aiflow-on-EC2/blob/main/screenshots/img10.png)

Screenshots of email received from Airflow on DAG run success:
![img11](https://github.com/vaxdata22/WeatherAPI-to-S3-bucket-to-Snowflake-ETL-by-Aiflow-on-EC2/blob/main/screenshots/img11.png)

I used my own email address as the sender for testing purposes:
![img12](https://github.com/vaxdata22/WeatherAPI-to-S3-bucket-to-Snowflake-ETL-by-Aiflow-on-EC2/blob/main/screenshots/img12.png)
